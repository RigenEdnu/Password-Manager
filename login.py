...
def show_main_menu():
    ...
    welcome_label = Label(root, text="Selamat Datang!", fg='#57a1f8', bg='white', font=('Microsoft YaHei UI Light', 23, 'bold'))
    welcome_label.pack(pady=50)

    create_button = Button(root, width=39, pady=7, text='Create', bg='#57a1f8', fg='white', border=0, cursor='hand2')
    create_button = Button(root, width=39, pady=7, text='Create', bg='#57a1f8', fg='white', border=0, cursor='hand2')
    create_button.pack(pady=10)

    update_button = Button(root, width=39, pady=7, text='Update', bg='#57a1f8', fg='white', border=0, cursor='hand2')
    update_button.pack(pady=10)

    delete_button = Button(root, width=39, pady=7, text='Delete', bg='#57a1f8', fg='white', border=0, cursor='hand2')
    delete_button.pack(pady=10)
    
    logout_button = Button(root, width=39, pady=7, text='LogOut', bg='#57a1f8', fg='white', border=0, cursor='hand2')
